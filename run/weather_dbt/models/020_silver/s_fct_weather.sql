    ...
    EXEC('create view "dbt_silver"."s_fct_weather__dbt_temp__dbt_tmp_vw" as WITH b_weather AS (
    SELECT 
        *
...
SELECT * FROM reorder;');
    ...
    EXEC('CREATE TABLE "wh_weather"."dbt_silver"."s_fct_weather__dbt_temp" AS SELECT * FROM "wh_weather"."dbt_silver"."s_fct_weather__dbt_temp__dbt_tmp_vw" 
