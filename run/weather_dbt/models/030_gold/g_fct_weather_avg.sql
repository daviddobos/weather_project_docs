    ...
    EXEC('create view "dbt_gold"."g_fct_weather_avg__dbt_temp__dbt_tmp_vw" as WITH s_fct_weather AS (
    SELECT
        m_valid_dt
        ,weather_pk
        ,city_nm
...
SELECT * FROM unit_conversion;');
    ...
    EXEC('CREATE TABLE "wh_weather"."dbt_gold"."g_fct_weather_avg__dbt_temp" AS SELECT * FROM "wh_weather"."dbt_gold"."g_fct_weather_avg__dbt_temp__dbt_tmp_vw" 
