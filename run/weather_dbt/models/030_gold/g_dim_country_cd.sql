    ...
    EXEC('create view "dbt_gold"."g_dim_country_cd__dbt_temp__dbt_tmp_vw" as WITH s_fct_astro AS (
    SELECT DISTINCT
        country_cd
...
SELECT * FROM union_select;');
    ...
    EXEC('CREATE TABLE "wh_weather"."dbt_gold"."g_dim_country_cd__dbt_temp" AS SELECT * FROM "wh_weather"."dbt_gold"."g_dim_country_cd__dbt_temp__dbt_tmp_vw" 
