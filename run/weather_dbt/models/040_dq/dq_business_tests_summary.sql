    ...
    EXEC('create view "dbt_dq"."dq_business_tests_summary__dbt_temp__dbt_tmp_vw" as WITH dq_business_tests AS (
    SELECT
        *
...
FROM summary;');
    ...
    EXEC('CREATE TABLE "wh_weather"."dbt_dq"."dq_business_tests_summary__dbt_temp" AS SELECT * FROM "wh_weather"."dbt_dq"."dq_business_tests_summary__dbt_temp__dbt_tmp_vw" 
