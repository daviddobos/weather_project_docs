    ...
    EXEC('create view "dbt_dq"."dq_standard_tests_summary__dbt_temp__dbt_tmp_vw" as WITH dq_standard_tests AS (
    SELECT
        *
...
FROM summary;');
    ...
    EXEC('CREATE TABLE "wh_weather"."dbt_dq"."dq_standard_tests_summary__dbt_temp" AS SELECT * FROM "wh_weather"."dbt_dq"."dq_standard_tests_summary__dbt_temp__dbt_tmp_vw" 
