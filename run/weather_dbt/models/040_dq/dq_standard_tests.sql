    ...
    EXEC('create view "dbt_dq"."dq_standard_tests__dbt_temp__dbt_tmp_vw" as WITH s_dim_city_not_null_city_pk_base AS (
    SELECT
        NULL AS m_valid_dt
        ,country_cd
        ,county_nm
...
SELECT * FROM reorder;');
    ...
    EXEC('CREATE TABLE "wh_weather"."dbt_dq"."dq_standard_tests__dbt_temp" AS SELECT * FROM "wh_weather"."dbt_dq"."dq_standard_tests__dbt_temp__dbt_tmp_vw" 
