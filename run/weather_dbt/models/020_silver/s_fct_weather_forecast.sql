    ...
    EXEC('create view "dbt_silver"."s_fct_weather_forecast__dbt_temp__dbt_tmp_vw" as WITH b_weather_forecast AS (
    SELECT 
        *
...
SELECT * FROM reorder;');
    ...
    EXEC('CREATE TABLE "wh_weather"."dbt_silver"."s_fct_weather_forecast__dbt_temp" AS SELECT * FROM "wh_weather"."dbt_silver"."s_fct_weather_forecast__dbt_temp__dbt_tmp_vw" 
